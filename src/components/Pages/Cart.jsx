...
import { addOneItem, clearCart, removeCartItem, removeOneItem } from "../../redux/actions/cart";
...
const Cart = () => {
  ...
  const onRemoveOneItem = (id) => {
    dispatch(removeOneItem(id))
  };
  const onPlusOneItem = (id) => {
          ...
          totalCount ? <div className="cart">
              ...
              </div>
              {
                addedPizzas.map((obj) =>
                  <CartItem
                    ...
                    onMinus={onRemoveOneItem}
                    onPlus={onPlusOneItem}
                  />)
              }
              <div className="cart__bottom">
                ...
                <div className="cart__bottom-buttons">
                  ...
                  <Button className="pay-btn" onClick={onClickOrder}>Оплатить сейчас</Button>
                </div>
              </div>
            </div> :
